filename = sprintf('../training/a01.wav');
...
filename = sprintf('../training/i01.wav');
...
filename = sprintf('../training/u01.wav');
...
filename = sprintf('../training/e01.wav');
...
filename = sprintf('../training/o01.wav');
